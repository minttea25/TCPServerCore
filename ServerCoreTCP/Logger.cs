...
namespace ServerCoreTCP
{
    ...
    public class ServerLogger : ILogger
    {
        ...
        static readonly ServerLogger _instance = new();
        #endregion
    ...
    {
        #region Singleton
        public static ClientLogger Instance => _instance;
        static readonly ClientLogger _instance = new();
        #endregion
